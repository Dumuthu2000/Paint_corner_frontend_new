...
const InvoiceReport = () => {
    ...
    useEffect(async () => {
        try {
            // Fetch job details
            const jobDetailsResponse = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/api/estimate/getEstimateJobDetails/${jobID}`);
            ...
            // Fetch table details
            const tablesDetailsResponse = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/api/invoice/getInvoice/${jobID}`);
            ...
            const insurancePriceTotal = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/api/invoice/insuranceTotal/${jobID}`);
