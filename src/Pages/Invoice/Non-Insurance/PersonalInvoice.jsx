...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  const handleJobSearchBtn = async(e)=>{
    ...
    if(!jobNo){
      ...
      await axios.get(`${import.meta.env.VITE_API_BASE_URL}/api/job/searchJob/${jobNo}`)
        .then((res)=>{
          ...
          setErrorVisible("block");
          setError("This Job Number Already Used or Invalid Job Number");
          setBackgroundColor("#fae0e4");
          setBorderColor("#ff0a54");
          setFontColor("#ff0a54");
          setIconColor("#ff0a54");
  ...
  const handleCreatePersonalInvoice = async () => {
    try {
      ...
      if (!formData.data || formData.data.length === 0) {
        ...
        await axios.post(`${import.meta.env.VITE_API_BASE_URL}/api/personalInvoice/createPersonalInvoice`, formData);
        setErrorVisible("none");
